...
* ************************************ */
Util.buildDetailGrid = async function(info) {
  ...
  detail += '<h3>'
  detail += '<p>Price: <span>$' + new Intl.NumberFormat('en-US').format(info.inv_price) + '</span></p>'
  detail += '</h3>'
  detail += '<h3>'
  detail += '<p>Miles: <span>' + new Intl.NumberFormat('en-US').format(info.inv_miles) + '</span></p>'
  detail += '</h3>'
